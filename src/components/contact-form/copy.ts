...
export const contactFormCopy = {
	"pt-PT": {
		...
		requestGroups: {
			brazilLaw: "Direito brasileiro",
			publicPolicyPortugal: "Políticas públicas e Portugal",
			researchKnowledge: "Investigação e conhecimento",
			other: "Outro",
		},
	...
	"pt-BR": {
		...
		requestGroups: {
			brazilLaw: "Direito brasileiro",
			publicPolicyPortugal: "Políticas públicas e Portugal",
			researchKnowledge: "Pesquisa e conhecimento",
			other: "Outro",
		},
		country: "País de residência",
		optional: "opcional",
	...
	en: {
		...
		requestGroups: {
			brazilLaw: "Brazilian law",
			publicPolicyPortugal: "Public policy and Portugal",
			researchKnowledge: "Research and knowledge",
			other: "Other",
		},
		country: "Country",
		optional: "optional",
