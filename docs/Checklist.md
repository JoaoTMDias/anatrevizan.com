...
- [x] Migrar a notificação interna para um template React Email.
- [x] Validar os emails em clientes reais.
- [x] Em cada release, concluir a jornada principal por teclado, verificar contraste em ambos os temas e fazer um smoke manual com VoiceOver e NVDA.
