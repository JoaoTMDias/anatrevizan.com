...
Abra `/admin`, escolha **Páginas** e depois a página pretendida. Cada página existe uma única vez e não pode ser criada, apagada ou renomeada.

Preencha primeiro **Português (Portugal)** e, logo abaixo, **English**. Pode guardar inglês parcial, mas a rota inglesa só é publicada quando todos os textos usados estiverem completos. O site nunca substitui inglês em falta por português.
...
No ambiente local, guardar altera os ficheiros do projeto. No Tina Cloud, guardar cria um commit em `main` e o Netlify publica-o. Antes de publicar, confirme visualmente PT e reveja toda a tradução EN com uma pessoa.
