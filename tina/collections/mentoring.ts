...
export const MentoringCollection: Collection = { name: 'mentoring', label: 'Mentoring', path: 'src/content/mentoring', format: 'json', ui: entityUi('academia/mentorias'), fields: [
